 ...
 *
 * Initialized lazily: `next build` prerenders pages that import this module
 * without the NEXT_PUBLIC_FIREBASE_* env set, so constructing the app at
 * import time would fail the build (auth/invalid-api-key).
 */
